...
@Singleton
public class NexInfoBox extends Overlay
{
    ...
    @Inject
    private NexInfoBox(final Client client, final NexPlugin plugin, final SpriteManager spriteManager, final NexConfig config)
    {
        this.client = client;
        this.plugin = plugin;
