...
import net.unethicalite.plugins.nex.maths.MathUtil;
import net.unethicalite.plugins.nex.movement.MovementUtil;
import net.unethicalite.plugins.nex.timer.TickTimer;
...
public class NexPlugin extends Plugin
{
    ...
    private void onGameTick(final GameTick event)
    {
        ...
        NPC currentMinion = getCurrentActiveMinion();
        if (currentMinion != null && minionActive)
            {
            MessageUtils.addMessage("Current minion is " + currentMinion);
            attackMinion(currentMinion);
            }

    }
	private void attackMinion(NPC currentMinion)
    {
    	if (currentMinion != null && currentMinion.getHealthRatio() > 0)
    	{
            currentMinion.interact("Attack");
    	}
    }
